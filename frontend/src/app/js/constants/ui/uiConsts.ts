...
const DEFAULT_GNOSIS_EXPLORER='https://gnosis.blockscout.com'
const DEFAULT_ETHEREUM_EXPLORER='https://eth.blockscout.com/'

const DEFAULT_GNOSIS_EXPLORER_TX='/tx/'
const DEFAULT_ETHEREUM_EXPLORER_TX='/tx/'
...
export {
  ...
  DEFAULT_GNOSIS_EXPLORER,
  DEFAULT_ETHEREUM_EXPLORER,

  DEFAULT_GNOSIS_EXPLORER_TX,
  DEFAULT_ETHEREUM_EXPLORER_TX,
