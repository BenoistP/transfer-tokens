...
const TokenInstanceMigrationList = ( {
  ...
  // console.debug(`TokenInstanceMigrationList.tsx render accountAddress: ${accountAddress}`);
    ...
    <>
      {
        tokensInstances?.sort(sortTokensInstances).map( (tokenInstance:TTokenInstance/* , index:number */) => {
          ...
          // console.debug(`TokenInstanceMigrationList.tsx render realTokenInstance key:${key}`);
          return (
